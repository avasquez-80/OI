...
def obtener_analisis_ia(ranking, ganador, stock_data, datos_dark=None, datos_lit=None, info_fund=None):
    ...
    try:
        ...
        response_main = llamar_con_reintentos(client, 'gemini-3.1-pro-preview', prompt_principal)
        ...
        response_news = llamar_con_reintentos(client, 'gemini-3.1-pro-preview', prompt_noticias)
