...
def obtener_analisis_ia(ranking, ganador, stock_data, datos_dark=None, datos_lit=None, info_fund=None):
    ...
    try:
        ...
        prompt_principal = f"""
        Actúa como un analista cuantitativo senior de derivados, microestructura y análisis fundamental. 
        ...
        - Prima total: ${prima:,.2f} | Heat Score Máx: {heat}
        {contexto_tecnico}
        {contexto_pools}
        {info_fund_str}
        ...
        2. Confluencia entre los muros institucionales (Dark/Lit Pools) y los niveles de precio actuales.
        3. Evaluación de riesgos derivados de noticias recientes o reportes de ganancias frente al vencimiento del contrato.
        4. Una recomendación operativa clara de gestión de riesgo basada en la confluencia general.
        Devuélvelo formateado en código HTML limpio usando etiquetas <ul> y <li> con formato profesional. No agregues bloques de código markdown alrededor.
        """
